...
.PARAMETER ApiName
The name of the API, currently limited to Microsoft Graph and any correctly formated prg API (must start "prg-<env>-", where <env> is the name of the environment, eg "dev")
...
param(
    ...
    [ValidatePattern("^(Microsoft Graph|prg-\w+-.+)$")]
    [Parameter(Mandatory=$true)]
    [String]$ApiName,
