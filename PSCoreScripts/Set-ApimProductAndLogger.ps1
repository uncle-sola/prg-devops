...
.EXAMPLE
Set-ApimProductAndLogger -ApimResourceGroup prg-foo-shared-rg -InstanceName prg-foo-shared-apim -ApiId barapi -ApiProductId bar-product -ApimLoggerName bar-logger
#>
[CmdletBinding()]
param(
