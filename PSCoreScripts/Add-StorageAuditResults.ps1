...
An array of environment names.  Assumes that the PRG naming convention for storage accounts is followed, ie <service><environment><project>str, eg prgfooprojectbarstr
